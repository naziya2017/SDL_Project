...
async function sendToGemini(pdfText) {
  ...
  const prompt = `
    ...
    1. Front Page: 
       - Student Enrollment: A number in the format "0801CSXXXXXXX".(it is written in the field box of enrollment in half left of page)
       - Table: A table with 5 rows representing questions and 6 columns (a, b, c, d, e, Total).
       - Grand Total: The total marks obtained.

    2. Other Pages(from second to last page of copy if nothing is scanned give it -1):
       - Marks: A number representing the total marks for that page, printed in the upper right corner.
    ...
    Example output in JSON format:(this is just and example you have to scan through the pdf data)
    {
